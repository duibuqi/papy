...
def iSurfacePlotTPR(output, svfilename, correction, samplsizes, sizeeff, nreps):
    """
...
def f_multiproc_cont(sampSizes, signThreshold, effectSizes, numVars, nRepeats, nSampSizes, nEffSizes, Samples_seg,
...
def f_multiproc(sampSizes, signThreshold, effectSizes, numVars, nRepeats, nSampSizes, nEffSizes, Samples_seg,
                correlationMat_seg, cols, cores, currCore):
    """
